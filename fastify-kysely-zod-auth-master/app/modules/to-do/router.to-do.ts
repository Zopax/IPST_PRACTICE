...
import { checkTodoAccess, checkTodoOwnership } from "../../common/config/middleware/middleware.to-do";
...
export const todoRouter = async (app: FastifyInstance) => {
    ...
    app.post("/:id/share", { preHandler: app.auth([checkTodoAccess]), schema: shareTodoFSchema }, todoController.shareTodo);
