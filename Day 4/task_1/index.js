        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    setTimeout(function () {
                        ...
                        var cleanedUsers = users.filter(function (user) { return user.isActive; }).map(function (user) { return (__assign(__assign({}, user), { name: user.name.toLowerCase().trim(), email: user.email.toLowerCase() })); });
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var cleanedUsers, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, cleanUserData(users)];
                case 1:
                    cleanedUsers = _a.sent();
